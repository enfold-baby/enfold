...
abstract final class AppTheme {
  ...
  static ThemeData _build(Brightness brightness) {
    ...
    final colorScheme = ColorScheme(
      ...
      primaryContainer: isDark ? AppColors.sageDeep : AppColors.sage.withValues(alpha: 0.15),
      ...
      surfaceContainerHighest:
          isDark ? AppColors.nightCard : AppColors.creamDeep,
      outline: isDark ? AppColors.nightLine : AppColors.bark.withValues(alpha: 0.2),
      outlineVariant:
          isDark ? AppColors.nightLine.withValues(alpha: 0.85) : AppColors.bark.withValues(alpha: 0.12),
    ...
    final bodyFont = GoogleFonts.nunitoTextTheme(displayFont);
    ...
    final segmentedStyle = SegmentedButton.styleFrom(
      ...
      selectedBackgroundColor:
          isDark ? AppColors.sageDeep : AppColors.sage.withValues(alpha: 0.22),
      selectedForegroundColor: isDark ? AppColors.cream : AppColors.sageDeep,
      side: BorderSide(
        color: isDark ? AppColors.nightLine : AppColors.bark.withValues(alpha: 0.15),
      ),
    );
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          side: BorderSide(
            color: isDark ? AppColors.nightLine : AppColors.sage.withValues(alpha: 0.5),
          ),
          minimumSize: const Size.fromHeight(48),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        ),
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return isDark ? AppColors.sage : AppColors.sage.withValues(alpha: 0.65);
          }
          return isDark ? AppColors.nightLine : AppColors.bark.withValues(alpha: 0.25);
        }),
      ),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        shadowColor: isDark ? Colors.black.withValues(alpha: 0.45) : Colors.transparent,
